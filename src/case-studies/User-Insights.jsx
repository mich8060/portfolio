    ...
    return (
        <>
            ...
            <div className="details--block">
                ...
                <p>Guerrilla Testing is a straightforward approach to recruiting users by engaging with individuals in environments where they naturally congregate. Here's how to effectively conduct guerrilla testing:</p>
                <ol>
                ...
                <p>By following these guidelines, you can effectively conduct guerrilla testing in a manner that respects participants' time and privacy while gathering valuable insights for your product development efforts.</p>
                <h3>Online Services</h3>
                <p>Online services refer to platforms provided by companies that specialize in hosting their own user base for usability testing and research purposes. These platforms offer convenient solutions for businesses seeking to gather feedback from a diverse pool of participants. Here are two examples of popular online services:</p>
                <ol>
                ...
                <ol>
                    ...
                    <li><strong>Establish Task Objectives:</strong> Define the specific tasks that users should be able to complete during the interview.</li>
                ...
                <ol>
                    <li>
                        <strong>Introductions (10 minutes):</strong>
                        <ul>
                    ...
                    <li>
                        <strong>Getting to Know Your Participant (10 minutes):</strong>
                        <ul>
                    ...
                    <li>
                        <strong>Detailed Questions or Exercises (20 minutes):</strong>
                        <ul>
                ...
                <ol>
                    <li>
                        <strong>Closed Questions:</strong> Avoid questions that can be answered with a simple "yes" or "no," as they limit the depth of the response and may hinder valuable insights.
                        <ul>
                            <li><i>Bad Example:</i> "Did you go out of town for the Holidays?" "Yes…"</li>
                            <li><i>Good Example:</i> "What did you do on your Holiday?" "We went to California and spent some time on the beach."</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Leading Questions:</strong> Refrain from asking questions that prompt or encourage the desired answer, as they can bias the participant's response.
                        <ul>
                            <li><i>Bad Example:</i> Interviewee: “I noticed this picture here.” Interviewer: “You mentioned that the picture was helpful... Which they ever actually did.”</li>
                            <li><i>Good Example:</i> Interviewee: “I noticed this picture here.” Interviewer: “You noticed the picture?”</li>
                        </ul>
                    </li>
                    <li>
                        <strong>Questions with Many Conjunctions:</strong> Avoid asking overly complex questions with multiple conjunctions, as they can confuse participants and dilute the clarity of the inquiry.
                        <ul>
                            <li><i>Bad Example:</i> “When you travel do you like to take public transportation or rent a car or maybe even catch a Lyft?"</li>
                            <li><i>Good Example:</i> “What kind of transportation do you take when you travel?”</li>
                        </ul>
                    </li>
                </ol>
                ...
                <ul>
                    ...
                    <li><strong>Participation:</strong> Encourage participants to show how they would navigate or interact with the product, putting themselves in the user's shoes.</li>
                    <li><strong>Demonstration:</strong> Request a demonstration of a particular feature or functionality to gain insights into user preferences and behavior.</li>
                    <li><strong>Elaboration:</strong> Invite participants to provide additional details or insights on a topic to deepen understanding and uncover hidden motivations.</li>
                    <li><strong>Sequence:</strong>Ask participants to walk through their typical process or workflow, revealing patterns and pain points in their user journey.</li>
                    <li><strong>Specific Examples:</strong> Inquire about specific instances or experiences related to the product to gain concrete insights into user behavior.</li>
