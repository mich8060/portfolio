                ...
                <TabPanel title="Detailed">
                    <div className="details--block">
                        <div className="details--left">
                            ...
                            <p>Since Project Broadcast is a text marketing platform, I found myself in an unusual yet advantageous position. Given our focus on developing the platform, I had a unique opportunity to directly engage with our customers. This access allowed me to communicate with customers like never before – simply by sending a chat. Leveraging this direct line of communication, I aimed to gain valuable insights into their needs and preferences.</p>
                            ...
                            <p>When I embarked on designing the logo, it wasn't prompted by a formal request from the business but rather by my own dissatisfaction. They had been content with using the wifi symbol as their logo, but I felt strongly that this didn't adequately represent the brand. Initially, I steered away from creating a logo centered around a text message symbol, instead focusing on interpreting the "broadcast" aspect of the name. While seeking inspiration, I stumbled upon an illustration attempting to create a 3D effect with red and blue outlines around a black shape. This sparked the idea of making our logo appear pop off of the page. Experimenting with the concept of two text messages interacting, I ultimately arrived at the design we have today.</p>
                            <div className="details--inline">
